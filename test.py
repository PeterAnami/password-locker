...
class TestCredentials(unittest.TestCase):
  ...
  def test_check_user(self):
    ...
    self.new_user = User('Peter','An\'am\'i','pswd100')
    self.new_user.save_user()
    user2 = User('Good','Lu\'ck\'y','pswd100')
    user2.save_user()
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('Peter','Facebook','platnumzpeter','pswd100')
	...
	def test__init__(self):
		...
		self.assertEqual(self.new_credential.account_name,'platnumzpeter')
	...
	def test_save_credentials(self):
		...
		twitter = Credential('Goodluck','Twitter','platnumzpeter','pswd100')
	...
	def test_display_credentials(self):
		...
		twitter = Credential('Goodluck','Twitter','platnumzpeter','pswd100')
		twitter.save_credentials()
		gmail = Credential('Goodluck','Gmail','platnumzpeter','pswd200')
